...
def basic():
    root.geometry("315x455")
    equalsbtn.config(width="225",image=equals_new_basic)
...
pi = Button(frame, image=piimg, width=75, height=80,command=piPress)
...
backspacebtn = Button(frame, image=backspace, width=70, height=64,command=delete)
backspacebtn.grid(column=4,row=4)

equalsbtn = Button(root, image=equals_new_basic, width=225, height=70,command=equals)
equalsbtn.place(y=371)
